...
try:
    ...
    try:
        ...
        raise ImportError("❌ CuPy not available - Install with 'pip install cupy-cuda11x' or 'pip install cupy-cuda12x'")
    try:
        from cuda.bindings import runtime as cudart
    except ImportError:
        print("⚠️  CUDA bindings not available - GPU visualization will be disabled")
        print("      To install CUDA bindings (https://pypi.org/project/cuda-python/):")
