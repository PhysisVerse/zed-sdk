...
This sample demonstrates asynchronous object detection using custom YOLO models (YOLOv5, YOLOv6, YOLOv8) in ONNX format with TensorRT optimization. The asynchronous processing improves performance by running inference in parallel with camera capture, while detected 2D boxes are ingested into the ZED SDK to extract 3D information.
